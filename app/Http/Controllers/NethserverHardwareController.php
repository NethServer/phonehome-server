...
class NethserverHardwareController extends Controller
{
    // Show a single hardware
    public function show($id)
    {
        $hardware = NethserverHardware::find($id);
        if (!$hardware) {
    ...
    public function store(Request $request)
    {
        ...
        $hardware = NethserverHardware::create($request->all());
    ...
    public function index(Request $request)
    {
        ...
        {
            return view('hardware-nethserver', ['matchingHardware' => collect()]);
        }
        ...
        return view('hardware-nethserver', ['groupedInputMatch' => $groupedInputMatch, 'count' => $count, 'rowsCount' => $rowsCount]);
    }
}
