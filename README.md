...
## QUERY POSTGRESQL
//Query per la creazione della vista dei nethserver
CREATE VIEW nethserver_hardware_view AS
SELECT
...
//Query per la creazione della vista dei nethsecurity
CREATE VIEW nethsecurity_hardware_view AS
SELECT
