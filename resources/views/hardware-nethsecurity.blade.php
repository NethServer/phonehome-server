...
<head>
    <meta charset="UTF-8">
    <title>Nethsecurity Hardware</title>
...
<div class="scrollable-content" style="overflow-y: scroll; max-height: 700px;">
    <div class="container">
    <h1 style="font-size: 24px; margin-bottom: 5px;">Find Nethsecurity Hardware</h1>
    <p style="margin-bottom: 40px; opacity: 0.6;">Enter a search term in the input box below to find Nethsecurity hardware matching your requirements.</p>

    <form action="{{ route('hardware-nethsecurity') }}" method="POST">
        @csrf
